  ...
  return (
    <div className="container-padding py-8 lg:py-12">
      ...
      <div className="flex items-center gap-4 mb-8 lg:mb-12">
        ...
        <div>
          <h1 className="text-2xl lg:text-3xl font-semibold">Saved Posts</h1>
          <p className="text-muted-foreground text-sm">Your reading list</p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 lg:py-24">
          ...
          <h2 className="text-xl lg:text-2xl font-semibold mb-2">No saved posts yet</h2>
